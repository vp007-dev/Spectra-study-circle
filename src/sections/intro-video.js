...
import videoBanner from 'assets/images/0.jpg';
  ...
  return (
    <Box as="section" sx={styles.section} variant="section.introVideo">
      <Container>
        <SectionHeading
          sx={styles.heading}
          title="We upload online tutorials on Youtube!"
          description="Every Student is precious to us!, We are here to help you learn and grow your child's skills. 💚"
        />
        ...
        <Box sx={styles.videoWrapper}>
          <Modal isOpen={isOpen}>
            ...
            <ResponsiveIframe
              width="853"
              height="480"
              src="https://youtu.be/tBDZZonjr8k"
