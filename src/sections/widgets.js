...
import banner from 'assets/images/widgets.jpg';
        ...
        <Box sx={styles.contentWrapper}>
          ...
          <Box sx={styles.rightContent}>
            <SectionHeading
              ...
              description="30+ years of experience in education, we are here to help you learn and grow your child's skills. 💚"
            />
            <Text sx={styles.listItem} as="p">
              <Image src={checkFilledCircle} alt="check icon" />
              Fill your child with education.
            </Text>
            <Text sx={styles.listItem} as="p">
              <Image src={checkFilledCircle} alt="check icon" />
              Education is a Key.
