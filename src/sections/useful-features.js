...
const data = [
  {
    ...
    description: `Fast performance of your kid is our main priority.`,
  },
  {
    id: 2,
    icon: diamond,
    title: 'Fees',
    description: `Call us at +919412360045 for full details. Terms and conditions apply.`
  },
  {
    id: 3,
    icon: help,
    title: 'Partnership deal',
    description: `We partner with top schools and colleges to provide the best learning experience for your kids.`,
  },
  {
    id: 4,
    icon: award,
    title: 'Customer Support',
    description: `Our hardwork depends on your support. We are always here to help you.`,
  },
];
